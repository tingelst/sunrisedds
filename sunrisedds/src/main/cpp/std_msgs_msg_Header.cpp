...
std_msgs_msg_Header__convert_from_java(jobject jmessage, std_msgs_msg_Header * message)
{
  ...
  message->stamp = *reinterpret_cast<builtin_interfaces_msg_Time *>(
    get_object_field(env, jmessage, "stamp", "Lbuiltin_interfaces/msg/Time;"));
...
std_msgs_msg_Header__convert_to_java(std_msgs_msg_Header * message, jobject jmessage)
{
  ...
  jclass jmessage_class = env->FindClass("std_msgs/msg/Header");
  jmethodID jconstructor_mid = env->GetMethodID(jmessage_class, "<init>", "()V");
  if (jmessage == nullptr) {
    jmessage = env->NewObject(jmessage_class, jconstructor_mid);
  }

  set_object_field(env, jmessage, "stamp", "Lbuiltin_interfaces/msg/Time;", &message->stamp);
...
Java_std_1msgs_msg_Header_getFromJavaConverter(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_std_1msgs_msg_Header_getToJavaConverter(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_std_1msgs_msg_Header_getTopicDescriptor(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_std_1msgs_msg_Header_getDestructor(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
