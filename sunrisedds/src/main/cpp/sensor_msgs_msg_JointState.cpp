...
#include "sensor_msgs_msg_JointState.h"
#include <dds/dds.h>
...
sensor_msgs_msg_JointState__convert_to_java(sensor_msgs_msg_JointState * message, jobject jmessage)
{
  ...
  jclass jmessage_class = env->FindClass("sensor_msgs/msg/JointState");
...
Java_sensor_1msgs_msg_JointState_getFromJavaConverter(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_sensor_1msgs_msg_JointState_getToJavaConverter(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_sensor_1msgs_msg_JointState_getTopicDescriptor(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_sensor_1msgs_msg_JointState_getDestructor(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
