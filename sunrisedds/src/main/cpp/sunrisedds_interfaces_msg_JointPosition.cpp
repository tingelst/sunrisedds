...
extern "C" {
#endif
JNIEXPORT jlong JNICALL Java_sunrisedds_1interfaces_msg_JointPosition_getFromJavaConverter
  (JNIEnv *, jclass);

JNIEXPORT jlong JNICALL Java_sunrisedds_1interfaces_msg_JointPosition_getToJavaConverter
  (JNIEnv *, jclass);

JNIEXPORT jlong JNICALL Java_sunrisedds_1interfaces_msg_JointPosition_getTopicDescriptor
  (JNIEnv *, jclass);

JNIEXPORT jlong JNICALL Java_sunrisedds_1interfaces_msg_JointPosition_getDestructor
  (JNIEnv *, jclass);
  ...
  jobject jmessage, sunrisedds_interfaces_msg_JointPosition * message)
{
  ...
  message->position = *reinterpret_cast<sunrisedds_interfaces_msg_JointQuantity *>(
    get_object_field(env, jmessage, "position", "Lsunrisedds_interfaces/msg/JointQuantity;"));
  ...
  sunrisedds_interfaces_msg_JointPosition * message, jobject jmessage)
{
  ...
  jclass jmessage_class = env->FindClass("sunrisedds_interfaces/msg/JointPosition");
  ...
  set_object_field(
    env, jmessage, "header", "Lstd_msgs/msg/Header;", &message->header);
  set_object_field(
    env, jmessage, "position", "Lsunrisedds_interfaces/msg/JointQuantity;", &message->position);
...
Java_sunrisedds_1interfaces_msg_JointPosition_getFromJavaConverter(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_sunrisedds_1interfaces_msg_JointPosition_getToJavaConverter(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_sunrisedds_1interfaces_msg_JointPosition_getTopicDescriptor(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
...
JNIEXPORT jlong JNICALL
Java_sunrisedds_1interfaces_msg_JointPosition_getDestructor(JNIEnv * env, jclass cls)
{
  (void)env;
  (void)cls;
