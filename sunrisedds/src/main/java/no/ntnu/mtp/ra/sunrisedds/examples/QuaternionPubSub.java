...
public class QuaternionPubSub {

    private static final Logger logger = LoggerFactory.getLogger(QuaternionPubSub.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            Topic<Quaternion> topic = participant.createTopic(Quaternion.class, "rt/quaternion");
            DataWriter<Quaternion> writer = publisher.createDataWriter(topic);
            DataReader<Quaternion> reader = subscriber.createDataReader(topic);
