...
public class Example {
    ...
    public static void main(String[] args) {
        try {
            ...
            Topic<JointQuantity> joint_quantity_write = participant.createTopic(JointQuantity.class,
                    "rt/write_quantity");
            DataWriter<JointQuantity> joint_quantity_writer = publisher.createDataWriter(joint_quantity_write);

            Topic<JointPosition> joint_position_write = participant.createTopic(JointPosition.class,
                    "rt/write_position");
